...
public interface RadioController {
    ...
    /**
     * Scan to next station. This will change frequency depending on given the
     * {@link ScanDirection} and will search for the next available frequency.
     * The scan stops, when a frequency is found or the original frequency is
     * reached again.
     *
     * If the scan reaches the lower UKW bound at 87.5MHz while scanning down,
     * the scan will proceed with the upper bound at 108MHz and vice versa.
     *
     * @param direction
     * @return
     * @throws IOException
    ...
    /**
     * Start playing the tuned station. Maybe use alsa mixer to redirect audio
     * interfaces or play in in plain java.
     */
    void playAudio();
