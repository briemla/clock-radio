...
public class ActiveDaysTest {
    ...
    public void dayAfterNextIsAllowedWhenMultipleAreAllowed() throws Exception {
        ...
        ActiveDays activeDays = new ActiveDays(
                EnumSet.of(DayOfWeek.THURSDAY, DayOfWeek.SATURDAY, DayOfWeek.MONDAY));
    ...
    public void with() throws Exception {
        ActiveDays extectedActiveDays = new ActiveDays(
    ...
    public void equalsAndHashCode() throws Exception {
        EqualsVerifier.forClass(ActiveDays.class).usingGetClass().verify();
    }
    ...
    public void notNeighbouringDays() throws Exception {
        ActiveDays days = new ActiveDays(EnumSet.of(DayOfWeek.MONDAY, DayOfWeek.WEDNESDAY,
    ...
    public void anotherNotNeighbouringDays() throws Exception {
        ActiveDays days = new ActiveDays(
    ...
    public void notNeighbouringRanges() throws Exception {
        ActiveDays days = new ActiveDays(EnumSet.of(DayOfWeek.MONDAY, DayOfWeek.TUESDAY,
