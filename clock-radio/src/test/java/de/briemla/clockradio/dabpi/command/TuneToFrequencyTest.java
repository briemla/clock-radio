...
public class TuneToFrequencyTest {
    ...
    public void parseIncorrectFrequencyInOutput() throws Exception {
        ...
        thrown.expectMessage(is("Tuned frequency differs from expected frequency: tuned: "
                + otherFrequency + " expected: " + frequency));
    ...
    public void equalsAndHashCode() throws Exception {
        EqualsVerifier.forClass(TuneToFrequency.class).usingGetClass().verify();
    }
}
